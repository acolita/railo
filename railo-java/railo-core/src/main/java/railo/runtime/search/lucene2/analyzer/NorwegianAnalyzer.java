...
public final class NorwegianAnalyzer extends Analyzer {
	...
	private String NORWEGIAN_STOP_WORDS[] = {
		"og", "i", "er", "det", "som", "̴", "til", "p̴", "for", "av", "at", "med", "har", "en", "om", "du", "de",
		"ikke", "no", "vi", "jeg", "kan", "den", "eller", "seg", "men", "et", "dei", "skal", "ein", "blir", "s̴",
		"vil", "fra", "var", "alle", "andre", "dette", "hva", "̴r", "bla"
	};
