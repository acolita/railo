 ...
 * 
	...
	Er erhï¿¤lt als Eingabe CFML Code, als String oder CFMLString, 
	der einen CFML Expression erhï¿¤lt und liefert ein CFXD Element zurï¿¼ck, 
	das diesen Ausdruck abbildet.
	Mithilfe der FunctionLibï¾’s, kann er Funktionsaufrufe, 
	die Teil eines Ausdruck sein kï¿¶nnen, erkennen und validieren. 
	...
	werden diese gegeneinander verglichen und der Aufruf wird als Build-In-Funktion ï¿¼bernommen, 
...
public abstract class AbstrCFMLExprTransformer {
	...
	*/
	...
	/**
	* Verarbeitet Ausdrï¿¼cke die inerhalb einer Klammer stehen.
	* <br />
	* EBNF:<br />
	...
	*/
	...
	/**
	* Hier werden die verschiedenen Mï¿¶glichen Werte erkannt 
	...
	* Die Lï¿¤nge des numerischen Wertes interessiert nicht zu ï¿œbersetzungszeit, 
	* ein "Overflow" fï¿¼hrt zu einem Laufzeitfehler. 
	...
	*/
	...
	/**
	* Liest die reinen Zahlen innerhalb des CFMLString aus und gibt diese als Zeichenkette zurï¿¼ck. 
	* <br />
	* EBNF:<br />
	* <code>"0"|..|"9";</code>
	...
	*/
	...
	/**
	* Liest den folgenden idetifier ein und prï¿¼ft ob dieser ein boolscher Wert ist. 
	...
	* gibt die Variable null zurï¿¼ck.
	* <br />
	* EBNF:<br />
	...
	*/
	...
	/**
	* Liest einen Identifier aus und gibt diesen als String zurï¿¼ck.
	* <br />
	* EBNF:<br />
	...
	*/
	...
	/**
	* Liest die Argumente eines Funktonsaufruf ein und prï¿¼ft ob die Funktion 
	* innerhalb der FLD (Function Library Descriptor) definiert ist. 
	* Falls sie existiert wird die Funktion gegen diese geprï¿¼ft und ein build-in-function CFXD Element generiert, 
	* ansonsten ein normales funcion-call Element.
	* <br />
	* EBNF:<br />
	* <code>[impOp{"," impOp}];</code>
	* @param name Identifier der Funktion als Zeichenkette
	* @param checkLibrary Soll geprï¿¼ft werden ob die Funktion innerhalb der Library existiert.
	* @return CFXD Element
	* @throws TemplateException 
	*/
