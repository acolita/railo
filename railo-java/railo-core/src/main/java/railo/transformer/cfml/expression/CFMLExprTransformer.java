...
public class CFMLExprTransformer extends AbstrCFMLScriptTransformer implements ExprTransformer {
	...
	/**
	 * Wird aufgerufen um aus dem ï¿¼bergebenen CFMLString einen Ausdruck auszulesen 
	 * und diesen in ein CFXD Element zu ï¿¼bersetzten.
	 * <br />
	 * Beispiel eines ï¿¼bergebenen String:<br />
